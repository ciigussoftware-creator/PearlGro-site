...
export default function GalleryHero() {
  return (
    <section className="relative overflow-hidden bg-bg-black">
      ...
      <Container className="relative flex flex-col items-start py-24 lg:py-32.5">
        ...
        <h1 className="max-w-155 pt-5 font-heading text-[clamp(40px,6vw,80px)] leading-[1.02] font-bold tracking-tight text-text">
          See Pearl Gro Take Shape.
        </h1>

        <p className="max-w-125 pt-6 text-[17px] leading-[1.7] text-muted">
