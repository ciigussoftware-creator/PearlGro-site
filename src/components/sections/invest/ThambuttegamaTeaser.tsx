...
export default function ThambuttegamaTeaser() {
  return (
    <section className="bg-bg-black pt-8 pb-8 lg:pt-10 lg:pb-10">
      <Container>
        <div className="grid grid-cols-1 overflow-hidden rounded-[18px] border border-text/6 bg-[rgba(10,14,10,0.5)] sm:grid-cols-[280px_1fr]">
          <div className="relative h-[220px] w-full sm:h-full sm:min-h-[240px]">
            <Image
          ...
          <div className="flex flex-col items-start justify-center px-8 py-7 sm:px-11 sm:py-7">
            <p className="font-mono text-[10px] tracking-[1.3px] text-muted/50 uppercase">
              Secondary Site · Site Assessment Phase
            </p>
            <h3 className="pt-3 font-heading text-[28px] font-bold tracking-[-0.28px] text-text/65">
              Thambuttegama
            </h3>
            <p className="max-w-[520px] pt-3 text-[15px] leading-[1.72] text-muted/55">
